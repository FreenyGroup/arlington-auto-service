...
const PrivacyPolicy = () => {
  return (
    <div className="container space">
      <h1> Privacy Policy for Arlington Auto Service</h1>
      <p>
        {' '}
        If you require any more information or have any questions
        about our privacy policy, please feel free to contact us by
        email at contact@arlington-autoservice.com.
      </p>
      <p>
        At arlington-autoservice.com we consider the privacy of our
        visitors to be extremely important. This privacy policy
        document describes in detail the types of personal information
        is collected and recorded by arlington-autoservice.com and how
        we use it.{' '}
      </p>
      <p>
        {' '}
        <b>Log Files</b>
        <br /> Like many other Web sites, arlington-autoservice.com
        makes use of log files. These files merely logs visitors to
        the site – usually a standard procedure for hosting companies
        ...
        date/time stamp, referring/exit pages, and possibly the number
        of clicks. This information is used to analyze trends,
      ...
      <p>
        ...
        <br />
        arlington-autoservice.com uses cookies to store information
        ...
        based upon visitors' browser type or other information that
      ...
      <p>
        ...
        beacons on our site. <br />
      </p>
      <p>
        <em>
          While each of these advertising partners has their own
          Privacy Policy for their site, an updated and hyperlinked
          resource is maintained here:{' '}
          <a href="https://www.arlington-autoservice.com/privacy-policy/">
      ...
      <p>
        ...
        arlington-autoservice.com and which are sent directly to your
        browser. They automatically receive your IP address when this
        occurs. Other technologies (such as cookies, JavaScript, or
        Web Beacons) may also be used by our site's third-party ad
        networks to measure the effectiveness of their advertising
        campaigns and/or to personalize the advertising content that
        you see on the site.{' '}
      </p>
      <p>
        {' '}
        arlington-autoservice.com has no access to or control over
      ...
      <p>
        ...
        certain practices. arlington-autoservice.com's privacy policy
        does not apply to, and we cannot control the activities of,
        such other advertisers or web sites. You may find a
        comprehensive listing of these privacy policies and their
        links here:{' '}
        <a
      ...
      <p>
        ...
        <br />
        arlington-autoservice.com does not knowingly collect any
        personally identifiable information from children under the
        age of 13. If a parent or guardian believes that
        arlington-autoservice.com has in its database the
        personally-identifiable information of a child under the age
        of 13, please contact us immediately (using the contact in the
        first paragraph) and we will use our best efforts to promptly
      ...
      <p>
        ...
        is valid for visitors to our website and regarding information
      ...
      <p>
        <b>Update</b>
        <br />
        This Privacy Policy was last updated on: Aug 11th, 2024.
